...
document.getElementById("btn").addEventListener("click", () => {
  ...
  mealAPI.then((getData)=>{
    ...
    sendData.meals.forEach((e, i) => {
        ...
        data +=`
        <h2 class='text-center text-secondary mt-5' ><span style="color:#daa520 ">Food Area: ${e.strArea}</span></h2>
        <h2 class='text-center text-warning'><span style="color:#800000">Food Name: ${e.strMeal}</span></h2>
        <div class="row">
        <div class="col-md-4">
